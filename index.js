...
const status = ['auf deinem server', '!help für alle befehle']
let current = 1
...
bot.on("ready", () =>{
    ...
    `Dieser Bot wurde von dein name Programmiert`
    ]
...
bot.on("message", async message =>{
    ...
    if(message.content === `${prefix}help`){
        ...
        .setTitle("**Die Hilfe**")
        .addField("Hilfe:", "!kick = Kickt einen User.", true)
        .addField("Hilfe:", "!ban = Bannt einen User.", true)
        .addField("Hilfe:", "!warn = Warnt einen User (Ab 3 Verwarnungen wird der User gebannt).", true)
        .addField("Hilfe:", "!serverinfo = Du siehst Infos über dem Server.", true)
        .addField("Hilfe:", "!flip = Für dem Casino schreib diesen Befehl einfach.", true)
        .addField("Hilfe:", "!coins = Zeigt an wie viele Coins du grade hast.", true)
        .addField("Hilfe:", "!clear = Löscht Nachrichten.", true)
        .addField("Hilfe:", "!user = Zeigt die Infos eines Users an.", true)
        .addField("Hilfe:", "!ping = Sendet deinen Ping.", true)
        .addField("Hilfe:", "!react = Reagiert auf einer Nachricht mit einem :thumbsup: (Schreib: !react <deine nachricht ohne diesen klammern>).", true)
        .addField("Hilfe:", "!buyrank = Damit kannst du einen Rank kaufen für dem Casino aber du brauchst genug Coins..", true)
        .addField("Hilfe:", "!setprefix = Du kannst einen Custom Prefix verwenden.", true)
        .addField("Hilfe:", "!globalsetup = Stellt den Global Chat ein.", true)
        .addField("Hilfe:", "!globalunsetup = Entfernt den Global chat .", true)
        .addField("Hilfe:", "!wiederhole = wiederholt eine Nachricht.", true)
        .addField("Hilfe:", "!ascii = Schreibt deine Nachricht anders um teste es einfach aus (!ascii <dein Name oder eine Nachricht>).", true)
        .addField("Hilfe:", "!createticket = erstellt ein Ticket (In Arbeit!).", true)
        .addField("Hilfe:", "!closeticket = Schließt ein Ticket (In Arbeit!).", true)
        .addField("Hilfe:", "!verify = Du kannst ein Verfy System machen (**Beta Phase**).", true)
        .addField("Hilfe:", "!level = Zeigt dein Level an.", true)
        .addField("Support:", "[Support Server](https://discord.gg/EhcYNYaCFV)", true)
        .addField("Support:", "[Lade mich ein](https://discord.com/api/oauth2/authorize?client_id=851081175098589203&permissions=8&scope=bot)", true)
        .setColor("BLUE")
        .setFooter(":D")
        .setThumbnail("https://media.discordapp.net/attachments/828251552926007324/850443719454359562/ezgif.com-gif-maker.gif")
...
//global chat
    ...
    if(message.content.startsWith(prefix+"warn")){
        ...
        message.channel.send(embed).then(msg=>msg.delete({timeout:"100000000"}));
